...
pub fn generate() -> Result<()> {
    handlebars_helper!(languages: |v: String| {
    ...
    template.register_helper("languages", Box::new(languages));
    template.register_escape_fn(handlebars::no_escape);
    template.register_template_string("default", r#"// WARNING: DO NOT EDIT THIS FILE! //
...
{{/each}}
    ...
    pub const fn languages(&self) -> &'static [crate::Language] {
        match self {
{{#each countries}}
            Self::{{this.code2}} => {{languages this.languages}},
{{/each}}
        }
    }
...
{{/each}}
    ...
    std::fs::write("out/country.rs", template.render("default", &indexmap! { "countries" => countries})?)?;
