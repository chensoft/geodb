...
impl Language {
    ...
    pub const fn name(&self) -> &'static str {
        match self {
            ...
            Self::CU => "Church Slavonic",
            Self::CU_RU => "Church Slavonic (Russia)",
            Self::CV => "Chuvash",
            ...
            Self::EN_SH => "English (Saint Helena)",
            ...
            Self::EN_VC => "English (Saint Vincent and the Grenadines)",
            ...
            Self::FF => "Fulani",
            Self::FF_BF => "Fulani (Burkina Faso)",
            Self::FF_CM => "Fulani (Cameroon)",
            Self::FF_GH => "Fulani (Ghana)",
            Self::FF_GM => "Fulani (Gambia)",
            Self::FF_GN => "Fulani (Guinea)",
            Self::FF_GW => "Fulani (Guinea-Bissau)",
            Self::FF_LR => "Fulani (Liberia)",
            Self::FF_MR => "Fulani (Mauritania)",
            Self::FF_NE => "Fulani (Niger)",
            Self::FF_NG => "Fulani (Nigeria)",
            Self::FF_SL => "Fulani (Sierra Leone)",
            Self::FF_SN => "Fulani (Senegal)",
            Self::FI => "Finnish",
            ...
            Self::FR_CD => "French (DR Congo)",
            Self::FR_CF => "French (Central African Republic)",
            Self::FR_CG => "French (Congo)",
            Self::FR_CH => "French (Switzerland)",
            Self::FR_CI => "French (Ivory Coast)",
            ...
            Self::FR_PM => "French (Saint Pierre and Miquelon)",
            ...
            Self::FR_WF => "French (Wallis and Futuna)",
            Self::FR_YT => "French (Mayotte)",
            Self::FRR => "North Frisian",
            Self::FRR_DE => "North Frisian (Germany)",
            Self::FUR => "Friulian",
            Self::FUR_IT => "Friulian (Italy)",
            Self::FY => "West Frisian",
            Self::FY_NL => "West Frisian (Netherlands)",
            Self::GA => "Irish",
    ...
    pub const fn native(&self) -> &'static str {
        match self {
            ...
            Self::BR => "Brezhoneg",
            Self::BR_FR => "Brezhoneg (Bro-C&#x27;hall)",
            Self::BRX => "बड़ो",
            ...
            Self::CY => "Cymraeg",
            Self::CY_GB => "Cymraeg (Deyrnas Unedig)",
            Self::DA => "Dansk",
            ...
            Self::DV => "ދިވެހި",
            Self::DV_MV => "ދިވެހި (މޯލްޑިވްސް އެވެ)",
            Self::DYO => "Joola",
            Self::DYO_SN => "Joola (Senegal)",
            Self::DZ => "རྫོང་ཁ",
            Self::DZ_BT => "རྫོང་ཁ (འབྲུག་རྒྱལ་ཡུལ།)",
            Self::EBU => "Kĩembu",
            ...
            Self::FF => "Fulɓe",
            Self::FF_BF => "Fulɓe (Burkinaa)",
            Self::FF_CM => "Fulɓe (Kameruun)",
            Self::FF_GH => "Fulɓe (Ganaa)",
            Self::FF_GM => "Fulɓe (Gammbi)",
            Self::FF_GN => "Fulɓe (Gine)",
            Self::FF_GW => "Fulɓe (Gine Bisaawo)",
            Self::FF_LR => "Fulɓe (Liberiyaa)",
            Self::FF_MR => "Fulɓe (Leydi Moritani)",
            Self::FF_NE => "Fulɓe (Niiseer)",
            Self::FF_NG => "Fulɓe (Naajeeriya)",
            Self::FF_SL => "Fulɓe (Siyeraa Leyoon)",
            Self::FF_SN => "Fulɓe (Senegaal)",
            Self::FI => "Suomi",
            ...
            Self::FR_CD => "Français (RD Congo)",
            Self::FR_CF => "Français (République centrafricaine)",
            Self::FR_CG => "Français (Congo)",
            ...
            Self::FRR => "Nordfriisk",
            Self::FRR_DE => "Nordfriisk (Dútslân)",
            Self::FUR => "Furlan",
            ...
            Self::GSW => "Schwiizerdütsch",
            Self::GSW_CH => "Schwiizerdütsch (Schwiiz)",
            Self::GSW_FR => "Schwiizerdütsch (Frankreich)",
            Self::GSW_LI => "Schwiizerdütsch (Liechtenstein)",
            Self::GU => "ગુજરાતી",
